...
public class EmailSendUtils {
	...
	private static String getTestCasesCountInFormat(int countTotalTCs, int countPassedTCs, int countFailedTCs,
			int countSkippedTCs) {
		System.out.println("count_totalTCs: " + countTotalTCs);
		System.out.println("count_passedTCs: " + countPassedTCs);
		System.out.println("count_failedTCs: " + countFailedTCs);
		System.out.println("count_skippedTCs: " + countSkippedTCs);
